...
// Class HomeworkProject will contain the main applet and will be the core program of the project.
   ...
   public class HomeworkApplet extends JApplet
   {
   // Panels
   ...
   // Is there an app in the center panel?
      ...
      private void createNorthPanel()
      {
         ...
         mainMenuButton.addActionListener(
               new ActionListener() 
               {
                  ...
                  {
                     if(app==false)	updateCenterPanel(main);
                     else
                     {
         ...
         JButton problemButton = new JButton(" Problem Description ");			// This button loads the description for the problem loaded into the center
      ...
      // buttonPanel is to prevent the button from stretching to the size of its cell in northPanel
         ...
         private class buttonResponses implements ActionListener
         {
            ...
            // Chapters
               ...
               if(choice.equals("Projects"))
               {
                  ...
                  button = new JButton("Peter's Group");
                  button.addActionListener(new buttonResponses());
                  problemPanel.add(KDUtil.wrap(button));
            ...
            public void chapter9(String choice)
            {
            // Chapter 9 problems
               ...
               {
                  JOptionPane.showMessageDialog(null, "Problem 9.7 deals with file writing and reading, which is a violation of security restrictions for applets.\n"
                     +"\nProblem 9.7 can be tested with the test application HomeworkRun.java found in the original zip folder.");
               }
            ...
            // Chapter 10 problems
               ...
               {
                  JOptionPane.showMessageDialog(null, "Problem 10.10 deals with file writing and reading, which is a violation of security restrictions for applets.\n"
                     +"\nProblem 10.10 can be tested with the test application HomeworkRun.java found in the original zip folder.");
               }
               if(choice.equals("Problem 10.11"))
               {
                  JOptionPane.showMessageDialog(null, "Problem 10.11 deals with file writing and reading, which is a violation of security restrictions for applets.\n"
                     +"\nProblem 10.11 can be tested with the test application HomeworkRun.java found in the original zip folder.");
               }
